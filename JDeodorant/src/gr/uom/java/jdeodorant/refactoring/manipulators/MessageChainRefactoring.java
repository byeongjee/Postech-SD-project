...
public class MessageChainRefactoring {
	 ...
	 * **/
	public static String makeNewMethodCode (String newMethodName, String returnType, List<String> stringOfArgumentType, List<Integer> numOfArgumentOfEachMethod, List<String> stringOfMethodInvocation) {
		String strOfMethod = "";
		strOfMethod += "public ";
	...
	/**
	    ...
	    *
	    * <Arguments> ICompilationUnit compUnitOfMethodInvocation: Information that
	    * java file (or class) that program add codes String strOfMethod: String that
	    * codes of Extracted Method
	    **/
	 ...
	 * **/
	 ...
	 /**
	    ...
	    *
	    * <Arguments> ICompilationUnit workingCopy: workingCopy helps to change codes
	    * IBuffer buffer: Ibuffer that contains whole of codes in java file int
	    * startPos: Start position that program added replaced codes int len: Length of
	    * replaced codes String stringForChange: String that contains replaced codes
	    **/
	public static void modifyCompUnit (ICompilationUnit workingCopy, IBuffer buffer, int startPos, int len, String stringForChange) {
		try {					

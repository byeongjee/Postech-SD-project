...
public class DeleteClassWizardPage extends UserInputWizardPage {
	...
	private DeleteClassRefactoring refactoring;
	private Map<Text, String> textMap;
	private Map<Text, String> defaultNamingMap;
	
	public DeleteClassWizardPage(DeleteClassRefactoring refactoring) {
		super("Delete Class Name");
	...
	public void createControl(Composite parent) {
		...
		movedMethodNameField.setText(refactoring.getName());
		
		textMap.put(movedMethodNameField, refactoring.getName());
		defaultNamingMap.put(movedMethodNameField, refactoring.getName());
